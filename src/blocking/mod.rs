...
//!
//! Conversely, the functionality in `reqwest_spooftls::blocking` must *not* be executed
...
//! [`reqwest_spooftls::Client`][crate::Client] instead. If the immediate context is only
...
//!
//! ```rust
//! # use reqwest_spooftls::{Error, Response};
//!
//! # fn run() -> Result<(), Error> {
//! let body = reqwest_spooftls::blocking::get("https://www.rust-lang.org")?
//!     .text()?;
//!
//! println!("body = {body:?}");
//! # Ok(())
...
//! Reader, you can use the `reqwest_spooftls::blocking::Body::new()` constructor.
//!
//! ```rust
